                ...
                <form class="form-horizontal" action="{{ route('admin.discount.update', $discount->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="expired_at" class="form-control" id="inputEmail3" placeholder="ملهت استفاده را وارد کنید" value="{{ old('expired_at', $discount->expired_at) }}">
                        </div>
                    </div>
                    <!-- /.card-body -->
